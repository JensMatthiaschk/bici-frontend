...
export const PinRating = () => {
  ...
  return (
    <div className="px-4 mb-10">
          ...
          return (
            <label key={i}>
              <input
                ...
                onClick={() => {
                  handleRatingChange(), setRatingInput(ratingValueCurrent);
                }}
              />
              <FaStar
                className="star mask mask-star-2"
                color={
                  ratingValueCurrent <= (hover || ratingInput)
                    ? "#fb923c"
                    : "grey"
                }
                size={30}
      ...
      {postRatingsAnswer?.success ? (
        <p className="text-green-500 bg-lime-100 rounded w-fit px-3 mb-4">
          rated successfully!
        </p>
      ) : (
        ""
