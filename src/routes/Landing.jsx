...
const Landing = () => {
  return (
    <>
      ...
      <div
        className="carousel w-screen h-screen" /* style={{ height: "80vh " }} */
      >
        <div
          id="slide1"
          className="flex carousel-item relative w-full  bg-cover bg-center "
          style={{
            backgroundImage: `url("http://cdn2.cyclist.co.uk/sites/cyclist/files/2017/01/st0040420.jpg")`,
          }}
        >
        ...
        >
          ...
          <div className="absolute bottom-5 sm:bottom-20 flex w-full justify-center">
            <img
